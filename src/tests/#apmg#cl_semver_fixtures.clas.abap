CLASS /apmg/cl_semver_fixtures DEFINITION
  PUBLIC
  CREATE PUBLIC.
...
CLASS /apmg/cl_semver_fixtures IMPLEMENTATION.
  ...
  METHOD increments.
    ...
    result = VALUE #(
      ...
      ( version         = '3.0.0-alpha.beta.5.4'   release         = 'prerelease' res = '3.0.0-alpha.beta.5.5'  identifier = 'alpha.beta' )
      ( version         = '3.0.0-alpha.beta.5.4'   release         = 'prerelease' res = '3.0.0-alpha.beta.5.5'  identifier = 'alpha.beta.5' )
      ( version         = '3.0.0-alpha.beta.gamma' release         = 'prerelease' res = '3.0.0-alpha.beta.0'    identifier = 'alpha.beta' )
  ...
  METHOD range_exclude.
    ...
    result = VALUE #(
      ...
      ( range = '^0.0.3'                  version = '0.0.3-alpha' incpre = abap_true )
      ( range = '^0.2.3'                  version = '0.2.3-alpha' incpre = abap_true )
  ...
  METHOD range_parse.
    ...
    result = VALUE #(
      ...
      ( range = |^{ /apmg/if_semver_constants=>max_safe_integer }.0.0| res = '' )
      ( range = |={ /apmg/if_semver_constants=>max_safe_integer }.0.0|
          res = |{ /apmg/if_semver_constants=>max_safe_integer }.0.0| )
      ( range = |^{ /apmg/if_semver_constants=>max_safe_integer - 1 }.0.0|
          res = |>={ /apmg/if_semver_constants=>max_safe_integer - 1 }.0.0 | &&
                |<{ /apmg/if_semver_constants=>max_safe_integer }.0.0-0| )
