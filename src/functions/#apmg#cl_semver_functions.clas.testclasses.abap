CLASS ltcl_semver_functions DEFINITION FOR TESTING RISK LEVEL HARMLESS
  ...
  PRIVATE SECTION.
    ...
    METHODS:
      clean FOR TESTING RAISING /apmg/cx_error,
      cmp_invalid FOR TESTING RAISING /apmg/cx_error,
      cmp_comparison FOR TESTING RAISING /apmg/cx_error,
      cmp_equality FOR TESTING RAISING /apmg/cx_error,
      coerce_to_null FOR TESTING RAISING /apmg/cx_error,
      coerce_to_valid FOR TESTING RAISING /apmg/cx_error,
      coerce_to_valid_incpre FOR TESTING RAISING /apmg/cx_error,
      coerce_rtl FOR TESTING RAISING /apmg/cx_error,
      coerce_rtl_incpre FOR TESTING RAISING /apmg/cx_error,
      compare FOR TESTING RAISING /apmg/cx_error,
      compare_build FOR TESTING RAISING /apmg/cx_error,
      compare_loose FOR TESTING RAISING /apmg/cx_error,
      diff FOR TESTING RAISING /apmg/cx_error,
      eq FOR TESTING RAISING /apmg/cx_error,
      gt FOR TESTING RAISING /apmg/cx_error,
      gte FOR TESTING RAISING /apmg/cx_error,
      inc FOR TESTING RAISING /apmg/cx_error,
      lt FOR TESTING RAISING /apmg/cx_error,
      lte FOR TESTING RAISING /apmg/cx_error,
      major FOR TESTING RAISING /apmg/cx_error,
      minor FOR TESTING RAISING /apmg/cx_error,
      neq FOR TESTING RAISING /apmg/cx_error,
      parse FOR TESTING RAISING /apmg/cx_error,
      patch FOR TESTING RAISING /apmg/cx_error,
      prerelease FOR TESTING RAISING /apmg/cx_error,
      rcompare FOR TESTING RAISING /apmg/cx_error,
...
CLASS ltcl_semver_functions IMPLEMENTATION.
  ...
  METHOD clean.
    ...
    LOOP AT tests INTO DATA(test).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>clean( test-range )
        exp = test-version
  ...
  METHOD cmp_invalid.
    ...
    TRY.
        /apmg/cl_semver_functions=>cmp( a = '1.2.3' op = 'a frog' b = '4.5.6' ).
  ...
  METHOD cmp_comparison.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>comparisons( ) INTO DATA(comparison).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>cmp( a = comparison-v0 op = '>' b = comparison-v1 loose = comparison-loose )
        exp = abap_true
        msg = msg && '>' ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>cmp( a = comparison-v1 op = '<' b = comparison-v0 loose = comparison-loose )
        exp = abap_true
        msg = msg && '<' ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>cmp( a = comparison-v1 op = '>' b = comparison-v0 loose = comparison-loose )
      ...
      cl_abap_unit_assert=>assert_equals(
        ...
        msg = msg && '<' ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>cmp( a = comparison-v1 op = '==' b = comparison-v1 loose = comparison-loose )
        exp = abap_true
        msg = msg && '==' ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>cmp( a = comparison-v0 op = '>=' b = comparison-v1 loose = comparison-loose )
  ...
  METHOD cmp_equality.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>equality( ) INTO DATA(equality).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>cmp( a = equality-v0 op = '' b = equality-v1 loose = equality-loose )
        exp = abap_true
        msg = msg && 'nop' ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>cmp( a = equality-v0 op = '=' b = equality-v1 loose = equality-loose )
      ...
      DATA(semver_v0) = /apmg/cl_semver=>create( version = equality-v0 loose = equality-loose ).
      DATA(semver_v1) = /apmg/cl_semver=>create( version = equality-v1 loose = equality-loose ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>cmp( a = semver_v0 op = '===' b = semver_v1 loose = equality-loose )
        exp = abap_true
        msg = msg && '===' ).
  ...
  METHOD coerce_to_null.
    ...
    DATA(mx) = /apmg/if_semver_constants=>max_safe_component_length.
    ...
    LOOP AT tests INTO DATA(test).
      DATA(semver) = /apmg/cl_semver_functions=>coerce( test ).
  ...
  METHOD coerce_to_valid.
    ...
    LOOP AT tests INTO DATA(test).
      DATA(semver) = /apmg/cl_semver_functions=>coerce( test-version ).
      DATA(expected) = /apmg/cl_semver_functions=>parse( test-res ).
  ...
  METHOD coerce_to_valid_incpre.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      DATA(expected) = /apmg/cl_semver_functions=>parse( version = test-res incpre = abap_true ).
  ...
  METHOD coerce_rtl_incpre.
    ...
    LOOP AT tests INTO DATA(test).
      DATA(semver) = /apmg/cl_semver_functions=>coerce( version = test-version rtl = abap_true incpre = abap_true ).
      DATA(expected) = /apmg/cl_semver_functions=>parse( version = test-res incpre = abap_true ).
  ...
  METHOD compare.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>comparisons( ) INTO DATA(comparison).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = comparison-v0 b = comparison-v1 loose = comparison-loose )
        exp = +1
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = comparison-v1 b = comparison-v0 loose = comparison-loose )
        exp = -1
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = comparison-v0 b = comparison-v0 loose = comparison-loose )
        exp = 0
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = comparison-v1 b = comparison-v1 loose = comparison-loose )
        exp = 0
        msg = msg ).
    ENDLOOP.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>equality( ) INTO DATA(equality).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = equality-v0 b = equality-v1 loose = equality-loose )
        exp = 0
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = equality-v1 b = equality-v0 loose = equality-loose )
        exp = 0
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = equality-v0 b = equality-v0 loose = equality-loose )
        exp = 0
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = equality-v1 b = equality-v1 loose = equality-loose )
        exp = 0
        msg = msg ).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare( a = semver_v0 b = semver_v1 loose = equality-loose )
        exp = 0
        msg = msg ).
    ENDLOOP.
  ...
  METHOD compare_build.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>compare_build( a = nobuild b = build0 )
      exp = -1 ).
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>compare_build( a = build0 b = build0 )
      exp = 0 ).
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>compare_build( a = build0 b = nobuild )
      exp = +1 ).

    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>compare_build( a = build0 b = '1.0.0+0.0' )
      exp = -1 ).
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>compare_build( a = build0 b = build1 )
      exp = -1 ).
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>compare_build( a = build1 b = build0 )
      exp = +1 ).
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>compare_build( a = build10 b = build1 )
      exp = +1 ).
  ...
  METHOD compare_loose.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      TRY.
          DATA(semver) = /apmg/cl_semver=>create( test-loose ).
          cl_abap_unit_assert=>fail( ).
        CATCH /apmg/cx_error ##NO_HANDLER.
      ENDTRY.

      semver = /apmg/cl_semver=>create( version = test-loose loose = abap_true ).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = test-loose b = test-strict loose = abap_true )
        exp = abap_true ).

      TRY.
          cl_abap_unit_assert=>assert_equals(
            act = /apmg/cl_semver_functions=>eq( a = test-loose b = test-strict )
            exp = abap_true ).
      ...
      TRY.
          semver = /apmg/cl_semver=>create( test-strict ).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>compare_loose( a = test-loose b = test-strict )
        exp = 0 ).
  ...
  METHOD diff.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>diff( version_1 = test-v1 version_2 = test-v2 )
        exp = test-res
        msg = msg ).
    ENDLOOP.
  ...
  METHOD eq.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>comparisons( ) INTO DATA(comparison).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = comparison-v0 b = comparison-v1 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = comparison-v1 b = comparison-v0 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = comparison-v0 b = comparison-v0 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = comparison-v1 b = comparison-v1 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
    ENDLOOP.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>equality( ) INTO DATA(equality).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = equality-v0 b = equality-v1 loose = equality-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = equality-v1 b = equality-v0 loose = equality-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = equality-v0 b = equality-v0 loose = equality-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>eq( a = equality-v1 b = equality-v1 loose = equality-loose )
        exp = abap_true
        msg = msg ).
    ENDLOOP.
  ...
  METHOD gt.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>comparisons( ) INTO DATA(comparison).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gt( a = comparison-v0 b = comparison-v1 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gt( a = comparison-v1 b = comparison-v0 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gt( a = comparison-v0 b = comparison-v0 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gt( a = comparison-v1 b = comparison-v1 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
    ENDLOOP.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>equality( ) INTO DATA(equality).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gt( a = equality-v0 b = equality-v1 loose = equality-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gt( a = equality-v1 b = equality-v0 loose = equality-loose )
        exp = abap_false
        msg = msg ).
    ENDLOOP.
  ...
  METHOD gte.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>comparisons( ) INTO DATA(comparison).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gte( a = comparison-v0 b = comparison-v1 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gte( a = comparison-v1 b = comparison-v0 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gte( a = comparison-v0 b = comparison-v0 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gte( a = comparison-v1 b = comparison-v1 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
    ENDLOOP.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>equality( ) INTO DATA(equality).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gte( a = equality-v0 b = equality-v1 loose = equality-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>gte( a = equality-v1 b = equality-v0 loose = equality-loose )
        exp = abap_true
        msg = msg ).
    ENDLOOP.
  ...
  METHOD lt.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>comparisons( ) INTO DATA(comparison).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lt( a = comparison-v0 b = comparison-v1 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lt( a = comparison-v1 b = comparison-v0 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lt( a = comparison-v0 b = comparison-v0 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lt( a = comparison-v1 b = comparison-v1 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
    ENDLOOP.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>equality( ) INTO DATA(equality).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lt( a = equality-v0 b = equality-v1 loose = equality-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lt( a = equality-v1 b = equality-v0 loose = equality-loose )
        exp = abap_false
        msg = msg ).
    ENDLOOP.
  ...
  METHOD lte.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>comparisons( ) INTO DATA(comparison).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lte( a = comparison-v0 b = comparison-v1 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lte( a = comparison-v1 b = comparison-v0 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lte( a = comparison-v0 b = comparison-v0 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lte( a = comparison-v1 b = comparison-v1 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
    ENDLOOP.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>equality( ) INTO DATA(equality).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lte( a = equality-v0 b = equality-v1 loose = equality-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>lte( a = equality-v1 b = equality-v0 loose = equality-loose )
        exp = abap_true
        msg = msg ).
    ENDLOOP.
  ...
  METHOD major.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>major( version = test-range loose = test-loose )
  ...
  METHOD minor.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>minor( version = test-range loose = test-loose )
        exp = condense( test-version )
        msg = msg ).
    ENDLOOP.
  ...
  METHOD neq.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>comparisons( ) INTO DATA(comparison).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>neq( a = comparison-v0 b = comparison-v1 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>neq( a = comparison-v1 b = comparison-v0 loose = comparison-loose )
        exp = abap_true
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>neq( a = comparison-v0 b = comparison-v0 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>neq( a = comparison-v1 b = comparison-v1 loose = comparison-loose )
        exp = abap_false
        msg = msg ).
    ENDLOOP.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>equality( ) INTO DATA(equality).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>neq( a = equality-v0 b = equality-v1 loose = equality-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>neq( a = equality-v1 b = equality-v0 loose = equality-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>neq( a = equality-v0 b = equality-v0 loose = equality-loose )
        exp = abap_false
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>neq( a = equality-v1 b = equality-v1 loose = equality-loose )
        exp = abap_false
        msg = msg ).
    ENDLOOP.
  ...
  METHOD parse.
    ...
    LOOP AT /apmg/cl_semver_fixtures=>invalid_versions( ) INTO DATA(invalid_version).
      ...
      cl_abap_unit_assert=>assert_initial(
        act = /apmg/cl_semver_functions=>parse( version = invalid_version-value loose = invalid_version-loose )
        msg = msg ).
    ENDLOOP.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>parse( '1.2.3' )->version
      exp = '1.2.3' ).

    DATA(s) = /apmg/cl_semver=>create( '4.5.6' ).

    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>parse( s )
      exp = s
      msg = 'return it if it is a SemVer obj' ).

    DATA(l) = /apmg/cl_semver=>create( version = '4.2.0' loose = abap_true ).

    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>parse( version = '4.2.0' loose = abap_true )->version
      exp = l->version
  ...
  METHOD patch.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>patch( version = test-range loose = test-loose )
        exp = condense( test-version )
        msg = msg ).
    ENDLOOP.
  ...
  METHOD prerelease.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>prerelease( version = test-version loose = test-loose )
        exp = test-prerel
        msg = msg ).
    ENDLOOP.
  ...
  METHOD rcompare.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>rcompare( a = '1.0.0' b = '1.0.1' )
      exp = +1 ).
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>rcompare( a = '1.0.0' b = '1.0.0' )
      exp = 0 ).
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>rcompare( a = '1.0.0+0' b = '1.0.0' )
      exp = 0 ).
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>rcompare( a = '1.0.1' b = '1.0.0' )
      exp = -1 ).
  ...
  METHOD rsort.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>rsort( list )
      exp = rsorted ).
  ...
  METHOD satisfies.
    ...
    DATA tests TYPE /apmg/cl_semver_fixtures=>ty_ranges.

    LOOP AT /apmg/cl_semver_fixtures=>range_include( ) INTO DATA(range_include).
      DATA(msg) = |{ range_include-range } { range_include-version } { range_include-loose } { range_include-incpre } |.

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>satisfies(
    ...
    LOOP AT /apmg/cl_semver_fixtures=>range_exclude( ) INTO DATA(range_exclude).
    ...
    LOOP AT tests INTO DATA(test).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_semver_functions=>satisfies( version = test-version range = test-range loose = test-loose )
        exp = abap_false
        msg = msg ).
    ENDLOOP.
  ...
  METHOD sort.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>sort( list )
      exp = sorted ).
  ...
  METHOD valid.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>valid( '1.2.3' )
      exp = '1.2.3' ).

    DATA(s) = /apmg/cl_semver=>create( '4.5.6' ).

    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>valid( s )
      exp = '4.5.6'
      msg = 'return the version if a SemVer obj' ).

    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>valid( version = '4.2.0foo' loose = abap_true )
      exp = '4.2.0-foo'
      msg = 'looseness as an option' ).

    DATA(mx) = /apmg/if_semver_constants=>max_safe_integer.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>valid( short_version && long_build )
      exp = short_version && long_build ).

    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_semver_functions=>valid( long_version && long_build )
